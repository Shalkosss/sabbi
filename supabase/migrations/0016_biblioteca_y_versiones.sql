...
--
--  Se escribio como 0011 y llega numerada 0016: mientras esperaba en su rama,
--  master gasto ese numero y cuatro mas. No cambia nada de lo que hace — todo
--  lo de aqui es `if not exists` y no depende de ninguna de las que se colaron
--  en el medio — pero el numero tenia que moverse: dos migraciones con el
--  mismo prefijo se aplican en un orden que decide el sistema de archivos, y
